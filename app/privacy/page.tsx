...
export const metadata = {
  ...
  description: '令和プログラミングのプライバシーポリシーです。個人情報の取り扱いについて説明しています。',
}
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            令和プログラミング（以下「当サービス」）は、ユーザーの皆様の個人情報保護を重要視し、個人情報の保護に関する法律（個人情報保護法）を遵守します。
        ...
        <section className="mb-8">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6">2.2 学習データ</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>演習の進捗状況</li>
            <li>獲得XP（経験値）</li>
            <li>レッスン完了状況</li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">収集した情報は、以下の目的で使用します：</p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>アカウントの作成・管理</li>
            <li>サービスの提供・運営</li>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-xl font-semibold mb-3 mt-6">5.2 Judge0</h3>
          <p className="text-gray-700 mb-4">
            コード実行エンジンとしてJudge0を使用しています。
            ユーザーが入力したコードは実行のためにJudge0サーバーに送信されますが、実行後は保存されません。
          </p>

          <h3 className="text-xl font-semibold mb-3 mt-6">5.3 楽天アフィリエイト</h3>
          <p className="text-gray-700 mb-4">
            当サービスは楽天アフィリエイトプログラムに参加しています。
            広告配信時にCookieが使用される場合があります。
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            以下の情報は、ランキング機能等により他のユーザーに公開される場合があります：
          </p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>ユーザー名（表示名）</li>
            <li>プロフィール画像</li>
