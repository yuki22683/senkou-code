...
export const metadata = {
  ...
  description: '令和プログラミングの利用規約です。本サービスを利用する前に必ずお読みください。',
}
...
export default function TermsOfServicePage() {
  return (
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      ...
      <div className="space-y-10 text-gray-800 text-sm leading-7">
        <p>
          この利用規約（以下、「本規約」といいます。）は、令和プログラミング運営（以下、「運営」といいます。）が提供するサービス「令和プログラミング」（以下、「本サービス」といいます。）の利用条件を定めるものです。本サービスを利用する全てのユーザー（以下、「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
        </p>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>コード実行機能を悪用してサーバーに過度な負荷をかける行為</li>
            <li>悪意のあるコードやマルウェアを実行しようとする行為</li>
            <li>その他、運営が不適切と判断する行為</li>
          </ol>
        </section>

        <section>
          <h2 className="text-xl font-bold mb-4 border-b pb-2">第5条（コード実行に関する注意事項）</h2>
          <ol className="list-decimal pl-6 space-y-2">
            <li>本サービスで提供されるコード実行機能は、学習目的でのみ使用できます。</li>
            <li>ユーザーが実行するコードは、サンドボックス環境で実行されますが、悪意のあるコードの実行は固く禁じられています。</li>
            <li>コード実行により生じた結果について、運営は一切の責任を負いません。</li>
            <li>コード実行機能の利用には、実行時間やリソースの制限があります。</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>本サービスで提供される学習コンテンツは、教育目的で作成されていますが、その正確性や完全性を保証するものではありません。</li>
          </ol>
        </section>
