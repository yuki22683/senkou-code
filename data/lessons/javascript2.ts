export const javascriptData2 = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "holeyCode": "// ショートハンドでオブジェクトを作る（x = 10）\nconst x = ___;\n// y = 20\nconst y = ___;\n// x をプロパティとして追加する\nconst point = { ___, y };\n// point.xを表示\nconsole.log(point.___);\n// point.yを表示\nconsole.log(point.___);",
      "correctLines": [
        "// ショートハンドでオブジェクトを作る",
        "const x = 10;",
        "const y = 20;",
