  ...
  "exercises": [
      ...
      },
    {
        ...
        "candidates": {
          ...
          "others": ["int main() {", "show", "n 0;", "stdio.h", "25", "}"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
        ...
        "candidates": {
          ...
          "others": ["main", "int", "n 0;", "stdlib.h", "p"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
        ...
        "candidates": {
          ...
          "others": ["Item", "price", "};", "main", "200", "item", "stdio.h", "0", "}"]
        },
        "testCases": [
          {
            "input": "",
