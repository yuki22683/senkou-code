  ...
  "exercises": [
    {
      ...
      "correctCode": "// package mainでモジュールを宣言\\npackage main\\n\\n// import \"fmt\"でfmtパッケージをインポート\\nimport \"fmt\"\\n\\n// func Firstでジェネリック関数を定義（型パラメータT any）\\nfunc First[T any](slice []T) T {\\n    // スライスのインデックス0の要素を返す\\n    return slice[0]\\n// ブロックを閉じる\\n}\\n\\n// func mainでmain関数を定義\\nfunc main() {\\n    // :=でnumsにint型スライス（10、20、30）を代入\\n    nums := []int{10, 20, 30}\\n    // fmt.PrintlnでFirst関数にnumsを渡した結果を出力\\n    fmt.Println(First(nums))\\n// ブロックを閉じる\\n}",
      ...
      },
    {
      ...
      "correctCode": "// package mainでモジュールを宣言\\npackage main\\n\\n// import \"fmt\"でfmtパッケージをインポート\\nimport \"fmt\"\\n\\n// func mainでmain関数を定義\\nfunc main() {\\n    // :=でsrcにint型スライス（10、20、30）を代入\\n    src := []int{10, 20, 30}\\n    // :=でdstにsrcと同じ長さの空スライスを作成して代入\\n    dst := make([]int, len(src))\\n    // copyでsrcの内容をdstにコピー（第1引数dst、第2引数src）\\n    copy(dst, src)\\n    // fmt.Printlnでdstを出力\\n    fmt.Println(dst)\\n// ブロックを閉じる\\n}", "holeyCode": "// package mainでモジュールを宣言\\npackage ___\\n\\n// import \"fmt\"でfmtパッケージをインポート\\n___ \\\"___\\\"\\n\\n// func mainでmain関数を定義\\nfunc ___() {\\n    // :=でsrcにint型スライス（10、20、30）を代入\\n    ___ := []___{___, ___, ___}\\n    // :=でdstにsrcと同じ長さの空スライスを作成して代入\\n    ___ := ___([]___, ___(___))\\n    // copyでsrcの内容をdstにコピー（第1引数dst、第2引数src）\\n    ___(___, ___)\\n    // fmt.Printlnでdstを出力\\n    ___.___(___\\n// ブロックを閉じる\\n}",
      "correctLines": [
          "// package mainでモジュールを宣言",
          "package main",
          "",
      ...
      },
    {
      ...
      "correctCode": "// package mainでモジュールを宣言\\npackage main\\n\\n// import \"fmt\"でfmtパッケージをインポート\\nimport \"fmt\"\\n\\n// func mainでmain関数を定義\\nfunc main() {\\n    // :=でscoresにstring-intのマップ（math: 90、english: 85）を代入\\n    scores := map[string]int{\"math\": 90, \"english\": 85}\\n    // for rangeでscoresをイテレート（キーk、値v）\\n    for k, v := range scores {\\n        // fmt.Printlnでkとvを出力\\n        fmt.Println(k, v)\\n    // ブロックを閉じる\\n    }\\n// ブロックを閉じる\\n}", "holeyCode": "// package mainでモジュールを宣言\\npackage ___\\n\\n// import \"fmt\"でfmtパッケージをインポート\\n___ \\\"___\\\"\\n\\n// func mainでmain関数を定義\\nfunc ___() {\\n    // :=でscoresにstring-intのマップ（math: 90、english: 85）を代入\\n    ___ := ___[___]___{\\\"___\\\": ___, \\\"___\\\": ___}\\n    // for rangeでscoresをイテレート（キーk、値v）\\n    for ___, ___ := range ___ {\\n        // fmt.Printlnでkとvを出力\\n        ___.___(___, ___)\\n    // ブロックを閉じる\\n    }\\n// ブロックを閉じる\\n}",
      "correctLines": [
          "// package mainでモジュールを宣言",
          "package main",
          "",
      ...
      },
    {
      ...
      "correctCode": "// package mainでモジュールを宣言\\npackage main\\n\\n// import \"fmt\"でfmtパッケージをインポート\\nimport \"fmt\"\\n\\n// func mainでmain関数を定義\\nfunc main() {\\n    // deferで無名関数を関数終了時に実行するよう予約\\n    defer func() {\\n        // ifでrecoverの戻り値rがnilでないか判定\\n        if r := recover(); r != nil {\\n            // fmt.Printlnで「caught」を出力\\n            fmt.Println(\"caught\")\\n        // ブロックを閉じる\\n        }\\n    // 無名関数を閉じて即座に実行\\n    }()\\n    // panicで「エラー」を発生させる\\n    panic(\"エラー\")\\n// ブロックを閉じる\\n}", "holeyCode": "// package mainでモジュールを宣言\\npackage ___\\n\\n// import \"fmt\"でfmtパッケージをインポート\\n___ \\\"___\\\"\\n\\n// func mainでmain関数を定義\\nfunc ___() {\\n    // deferで無名関数を関数終了時に実行するよう予約\\n    defer ___() {\\n        // ifでrecoverの戻り値rがnilでないか判定\\n        if ___ := ___(); ___ != ___ {\\n            // fmt.Printlnで「caught」を出力\\n            ___.___(\\\"___\\\")\\n        // ブロックを閉じる\\n        }\\n    // 無名関数を閉じて即座に実行\\n    ___()\\n    // panicで「エラー」を発生させる\\n    ___(\\\"___\\\")\\n// ブロックを閉じる\\n}",
      "correctLines": [
          "// package mainでモジュールを宣言",
          "package main",
          "",
