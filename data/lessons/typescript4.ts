  ...
  "exercises": [
    {
      ...
      "holeyCode": "// ここに is と入力して、x が number かどうか教えてね\nfunction isNumber(x: unknown): x ___ number {\n  return typeof x === 'number';\n}\n\nconst value: unknown = 42;\nif (isNumber(value)) {\n  console.log(value * 2);\n}",
      "correctLines": [
        "// ここに is と入力して、x が number かどうか教えてね",
        "function isNumber(x: unknown): x is number {",
        "  return typeof x === 'number';",
        "}",
        "",
