  ...
  "exercises": [
    {
      ...
      "lineHints": [null, "型ガードの戻り値型を定義します。", null, "チェックする型名を文字列で指定します。", null, null, null, "チェックする値を数値で指定します。", null, "型ガード関数に渡す変数を指定します。", null, "掛け算の倍数を数値で指定します。", null],
      "candidates": {
        "keywords": ["is", "as", "in"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, "戻り値がないことを示す型です。", null, "戻り値がないことを示す型です。", null, null, null, "プロパティの存在をチェックする演算子です。", null, "デバッグ用コンソールなどに文字列を出力します。", null, null, "デバッグ用コンソールなどに文字列を出力します。", null, null, null, null, null],
      "candidates": {
        "keywords": ["in", "of", "has"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, "データは文字列なので `string` です。", null, "エラーは文字列なので `string` です。", null, "ユニオン型を作る演算子です。", null, null, null, "判別プロパティ名を指定します。", null, null, "成功時に取得するプロパティ名を指定します。", null, null, null, "失敗時に取得するプロパティ名を指定します。", null, null, null, null, null, "成功時のデータ値を文字列で指定します。"],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "ユニオン型に色を追加する演算子です。", null, null, null, null, "赤色のカラーコードを16進数で返します。", null, "緑色のカラーコードを16進数で返します。", null, "青色のカラーコードを16進数で返します。", null, null, "全ケースを処理した後は到達しないことを示す型です。", null, "変数の値を呼び出し元に返します（戻り値）。", null, null, null, null, "カラーコードを取得したい色を指定します。"],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "ユニオン型を作る演算子です。", null, "ユニオン型を作る演算子です。", null, "テンプレートリテラルを開始するバッククォートです。", null, null, "有効なルートパターンを文字列で指定します。", null, "出力する変数を指定します。"],
      "candidates": {
        "keywords": ["`", "'", "\""]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, "ユニオン型を作る演算子です。", null, "型を除外するユーティリティ型です。", null, null, "除外されていないステータスを文字列で指定します。", null, "出力する変数を指定します。"],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "ユニオン型を作る演算子です。", null, "型を抽出するユーティリティ型です。", null, null, "抽出されたマウスイベントを文字列で指定します。", null, "出力する変数を指定します。"],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "ユニオン型を作る演算子です。", null, "null/undefinedを除外するユーティリティ型です。", null, null, "確定した文字列の値を指定します。", null, "出力する変数を指定します。"],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, "デバッグ用コンソールなどに文字列を出力します。", null, null, "関数の引数型を取得するユーティリティ型です。", null, "年齢の値を数値で指定します。", null, "スプレッド構文で展開する配列を指定します。"],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "データの型は文字列なので `string` です。", null, "Promiseの解決型を取得するユーティリティ型です。", null, null, "データの値を文字列で指定します。", null, "取得したいプロパティ名を指定します。"],
      "candidates": {
