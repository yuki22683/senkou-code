export const cppData = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "correctLines": ["#include <iostream>", "int main() {", "    std::cout << 10 % 3 << std::endl;", "    return 0;", "}"],
      "lineHints": [null, null, "あまりを求める % 演算子を使います。", null, null],
      "candidates": { "operators": ["%", "+", "-", "*", "/"] },
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\nint main() {\n    // scoreに50を入れる\n    int score = ___ ;\n    // 10点プラスする\n    score ___ 10;\n    // 結果を表示\n    std::cout << score << std::endl;\n    return 0;\n}",
      "correctLines": ["#include <iostream>", "int main() {", "    int score = 50;", "    score += 10;", "    std::cout << score << std::endl;", "    return 0;", "}"],
      "lineHints": [null, null, "50 と入力しましょう。", "+= を使って加算します。", null, null, null],
    ...
    },
    {
      ...
      "correctLines": ["#include <iostream>", "#include <vector>", "#include <string>", "int main() {", "    std::vector<std::string> fruits = {\"りんご\", \"バナナ\"};", "    std::cout << fruits[1] << std::endl;", "    return 0;", "}"],
      "lineHints": [null, "vector を使うためにインクルードします。", "string を使うためにインクルードします。", null, "{\"りんご\", \"バナナ\"} と入力して初期化します。", "2番目の番号は 1 です。"],
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\nint main() {\n    // scoreに100を入れる\n    int score = ___ ;\n    // > で「より大きい」を比較\n    if (score ___ 80) {\n        // 'Perfect' と入力\n        std::cout << \"___\" << std::endl;\n    }\n    return 0;\n}",
      "correctLines": ["#include <iostream>", "int main() {", "    int score = 100;", "    // > で「より大きい」を比較", "    if (score > 80) {", "        // 'Perfect' と入力", "        std::cout << \"Perfect\" << std::endl;", "    }", "    return 0;", "}"],
      "lineHints": [null, null, "score = 100 と入力しましょう。", null, "比較するための記号 `>` を入力しましょう。", null, "Perfect と表示します。"],
    ...
    },
    {
      ...
      "correctLines": ["#include <iostream>", "int main() {", "    int score = 85;", "    if (score >= 80 && score <= 100) {", "        std::cout << \"Pass\" << std::endl;", "    }", "    return 0;", "}"],
      "lineHints": [null, null, "85 と入力しましょう。", "両方の条件を満たすので && を使います。", "Pass と入力しましょう。", null, null, null],
    ...
    },
    {
      ...
      "correctLines": ["#include <iostream>", "#include <map>", "#include <string>", "int main() {", "    std::map<std::string, int> scores;", "    // 'Math' と入力（キー名）", "    scores[\"Math\"] = 90;", "    // 'Math' と入力（同じキー名）", "    std::cout << scores[\"Math\"] << std::endl;", "    return 0;", "}"],
