  ...
  "exercises": [
    ...
    },
    {
      ...
      "tutorialSlides": [
        ...
        {
          "title": "数字のラベル int",
          "image": "/illustrations/common/input_keyboard.png",
    ...
    },
    {
      ...
      "tutorialSlides": [
        {
          "title": "あまりを求める",
          "image": "/illustrations/common/light_beam.png",
          "content": "# 割り算の「あまり」を知りたい！\n\n割り算をしたときに、割り切れなくて「あまり」が出ることがありますよね。\n`%` という記号を使うと、その **あまり** だけを計算してくれます。\nこれを「剰余（じょうよ）」と呼びます。"
        },
        {
          "title": "% の使い方",
          "image": "/illustrations/common/light_bulb_off.png",
    ...
    },
    {
      ...
      "tutorialSlides": [
        ...
        {
          "title": "-= も使える",
          "image": "/illustrations/common/logic_circuit.png",
      ...
      "tutorialSlides": [
        {
          ...
          "image": "/illustrations/common/magnifying_glass_plus.png",
          "content": "# プログラムに判断させてみよう\n\n「雨が降ったら傘をさす」「晴れたら外で遊ぶ」\nこんなふうに、状況によって動きを変えることを **条件分岐（じょうけんぶんき）** と呼びます。\nプログラムに「もし〜なら、これをしてね」と教えてあげましょう。"
        },
        {
          "title": "if文",
          "image": "/illustrations/common/map_treasure.png",
    ...
    },
    {
      ...
      "tutorialSlides": [
        ...
        {
          "title": "&& と || の使い方",
          "image": "/illustrations/common/mountain_climb.png",
    ...
    },
    {
      ...
      "tutorialSlides": [
        {
          "title": "繰り返し（ループ）とは？",
          "image": "/illustrations/common/ocean_wave.png",
    ...
    },
    {
      ...
      "tutorialSlides": [
        {
          "title": "関数（かんすう）とは？",
          "image": "/illustrations/common/order.png",
        ...
        {
          "title": "手順をまとめる",
          "image": "/illustrations/common/output_monitor.png",
