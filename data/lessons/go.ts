        ...
        "tutorialSlides": [
          {
            ...
            "content": "# Google生まれの、シンプルで速い言語\n\n**Go（ゴー）** は、Google（グーグル）が開発したプログラミング言語です。無駄を省いた「究極のシンプルさ」と、たくさんの仕事を同時にこなす「並列処理（へいれつしょり）」が得意です。\n\n**身近な例え：**\nGoは、効率を極めた「最新の物流センター」のようなイメージです。たくさんの荷物（データ）を、迷いなく最短ルートでテキパキとさばいていきます！"
          },
          {
            "title": "Go言語の「きまり文句」",
