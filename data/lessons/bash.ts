  ...
  "exercises": [
      ...
      },
    {
        ...
        "tutorialSlides": [
          ...
          {
            "title": "Bashの変数は特別ルール！",
            "image": "/illustrations/common/class_building.png",
      ...
      },
    {
        ...
        "tutorialSlides": [
          {
            "title": "計算はコンピュータにお任せ",
            "image": "/illustrations/common/cogwheel_large.png",
            "content": "# 高速な計算処理\n\nコンピュータは人間よりもずっと速く計算できます。プログラミングでは、特別な記号を使って計算の指示を出します。\n\n**使える記号：**\n- `+` たし算\n- `-` ひき算\n- `*` かけ算\n- `/` わり算"
          },
          {
            "title": "Bashの計算ルール",
            "image": "/illustrations/common/collection_cubes.png",
      ...
      },
    {
        ...
        "tutorialSlides": [
          ...
          {
            "title": "Bashの比較記号",
            "image": "/illustrations/common/compass_rose.png",
      ...
      },
    {
        ...
        "tutorialSlides": [
          {
            "title": "関数（かんすう）とは？",
            "image": "/illustrations/common/diamond_jewelry.png",
