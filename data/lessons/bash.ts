export const bashData = {
  ...
  "lessonDescription": "コンピュータに直接指示を出すための言葉「Bash（バッシュ）」のきほんを学びましょう。黒い画面（ターミナル）を自由にあやつれるようになります。",
  ...
  "exercises": [
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["a", "b", "echo", "5", "3", "# 算術展開を使ってたし算の結果を表示"]
        },
        "testCases": [
          {
            "input": "",
    ...
    {
      "title": "ちがう場合はどうしましょう？",
      "description": "if文でelseを使って、条件に合わない場合の処理を書く方法を学びます",
      "tutorialSlides": [
        {
          "title": "それ以外の場合は？",
    ...
    {
      "title": "中身を全部出してみましょう",
      "description": "for文で配列の全要素を順番に処理する方法を学びます",
      "tutorialSlides": [
        {
          "title": "繰り返し（ループ）とは？",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["}", "こんにちは", "echo", "# greet関数を呼び出す"]
        },
        "testCases": [
          {
            "input": "",
