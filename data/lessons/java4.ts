export const javaData4 = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "holeyCode": "// ここに extends と入力して、Number（数字）の仲間だけにしてね\nclass Calculator<T ___ Number> {\n    private T value;\n    public Calculator(T v) { value = v; }\n    public double getDouble() { return value.doubleValue(); }\n}\n\npublic class Main {\n    public static void main(String[] args) {\n        Calculator<Integer> calc = new Calculator<>(42);\n        System.out.println(calc.getDouble());\n    }\n}",
      "correctLines": [
        "// ここに extends と入力して、Number（数字）の仲間だけにしてね",
    ...
    },
    {
      ...
      "holeyCode": "import java.util.*;\n\n// ここに Comparable と入力して、比べられるようにしてね\nclass Score implements ___<Score> {\n    int value;\n    Score(int v) { value = v; }\n    public int compareTo(Score other) {\n        return this.value - other.value;\n    }\n}\n\npublic class Main {\n    public static void main(String[] args) {\n        List<Score> scores = Arrays.asList(new Score(80), new Score(60));\n        Collections.sort(scores);\n        System.out.println(scores.get(0).value);\n    }\n}",
      "correctLines": [
        "import java.util.*;",
        "",
        "// ここに Comparable と入力して、比べられるようにしてね",
    ...
    },
    {
      ...
      "holeyCode": "// ここに enum と入力して、種類を並べてね\n___ Day {\n    MON, TUE, WED, THU, FRI, SAT, SUN\n}\n\npublic class Main {\n    public static void main(String[] args) {\n        Day today = Day.MON;\n        System.out.println(today);\n    }\n}",
      "correctLines": [
        "// ここに enum と入力して、種類を並べてね",
        "enum Day {",
        "    MON, TUE, WED, THU, FRI, SAT, SUN",
        "}",
        "",
