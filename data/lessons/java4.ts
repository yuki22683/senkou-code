  ...
  "exercises": [
    {
      ...
      "lineHints": [null, null, null, "新しいクラス（Box）を定義します。", null, null, null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`set` で値を設定します。", null, "`get` で値を取得します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "新しいクラス（Calculator）を定義します。", null, null, null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`getDouble` メソッドを呼び出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, "`?` で任意の型を表します。", null, null, "変数の値をコンソールに出力し、改行します。", null, null, null, null, "`asList` でリストを作成します。", null, "`printAll` メソッドを呼び出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` で HashMap を作成します。", null, "`put` でキーと値を追加します。", null, "`put` でキーと値を追加します。", null, "`get` で値を取得します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` で HashMap を作成します。", null, "`put` でキーと値を追加します。", null, "`put` でキーと値を追加します。", null, "指定された回数や範囲で、繰り返し処理（ループ）を行います。", null, "`getKey` でキーを取得します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` と `asList` でリストを作成します。", null, "`comparing` でプロパティを基準に比較します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "新しいクラス（Score）を定義します。", null, null, null, null, "`return` で比較結果を返します。", null, null, null, null, null, null, "`asList` でリストを作成します。", null, "`sort` でソートします。", null, "`get` で要素を取得します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "`enum` で列挙型を定義します。", null, null, null, null, null, null, "`MON` で列挙値を取得します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` で LinkedList を作成します。", null, "`offer` でキューに要素を追加します。", null, "`offer` でキューに要素を追加します。", null, "`poll` で要素を取り出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` で ArrayDeque を作成します。", null, "`push` でスタックに積みます。", null, "`push` でスタックに積みます。", null, "`pop` でスタックから取り出します。", null, null],
      "candidates": {
