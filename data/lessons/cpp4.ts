  ...
  "exercises": [
    {
      ...
      "holeyCode": "#include <iostream>\n#include <memory>\nusing namespace std;\n\nint main() {\n    // ここに make_unique と入力して、自分だけのポインタを作ってね\n    auto p = ___<int>(99);\n    cout << *p << endl;\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "#include <memory>",
        "using namespace std;",
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\n#include <string_view>\nusing namespace std;\n\n// ここに string_view と入力して文字列を受け取ってね\nvoid greet(___ name) {\n    cout << \"Hello, \" << name << endl;\n}\n\nint main() {\n    greet(\"World\");\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "#include <string_view>",
        "using namespace std;",
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\nusing namespace std;\n\n// ここに noexcept と入力して、例外を投げないことを約束してね\nint add(int a, int b) ___ {\n    return a + b;\n}\n\nint main() {\n    cout << add(10, 20) << endl;\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "using namespace std;",
        "",
