      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["using", "namespace", "std", "int", "main", "variant", "double", "v", "3.14", "cout", "endl", "return", "0", "}", "#include <iostream>", "#include <variant>", "// variant で複数型のうち1つを保持", "variant<int, double> v = 3.14;", "cout << get<double>"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["using", "namespace", "std", "int", "main", "tuple", "double", "string", "t", "1", "2.5", "\\\"hi\\\"", "a", "b", "c", "cout", "\\\" \\\"", "endl", "return", "0", "}", "#include <iostream>", "#include <tuple>", "\"", "<", "c << endl", "// tにtuple{1, 2.5, \"hi\"}を代入", "tuple<int, double, string> t{1, 2.5, \"hi\"};", "auto [a, b, c] = t;", "return 0;"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["using", "namespace", "std", "int", "main", "vector", "v", "1", "2", "3", "4", "5", "sum", "begin()", "end()", "0", "cout", "endl", "return", "}", "#include <iostream>", "#include <vector>", "#include <numeric>", "using namespace std;", "int main() {", "vector<int> v = {1, 2, 3, 4, 5}", "// accumulate で要素を集約", "cout << sum << endl;"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["using", "namespace", "std", "int", "main", "vector", "v", "1", "2", "3", "4", "5", "auto", "it", "begin()", "end()", "int x", "return", "x", "cout", "*it", "endl", "0", "}", "#include <iostream>", "#include <vector>", "#include <algorithm>", "using namespace std;", "int main() {", "vector<int> v = {1, 2, 3, 4, 5}", "// find_if で条件に合う要素を検索", "cout << *it << endl;"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["using", "namespace", "std", "int", "main", "vector", "v", "3", "1", "4", "5", "begin()", "end()", "int a, int b", "return", "a", "b", "int n", "cout", "n", "\\\" \\\"", "endl", "0", "}", "#include <iostream>", "#include <vector>", "#include <algorithm>", ": v", "using namespace std;", "int main() {", "vector<int> v = {3, 1, 4, 1, 5}", "// sort でソート", "for", "return 0;"]
        },
        "testCases": [
          {
            "input": "",
