      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "a", "5", "b", "3", "echo", "$a", "?>", "// はこに数字を入れる", "cho", "+ $b", "/", "1つのはこに数字を入れる", "算した結果を表示する"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "echo", "10", "3", "?>", "// echoで10を3で割ったあまりを出力"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "score", "echo", "?>", "// scoreに50を入れる", "/", "点プラスする", "score;を表示", "$scoreを表示"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "age", "18", "20", "{", "echo", "おとな", "}", "みせいねん", "?>", "// ageに18を入れる", "/", "以上かを比較する演算子", "20歳以上のときのメッセージ（'おとな'）", "lseで「そうでなければ」", "// それ以外のメッセージ（'未成年'）", "// それ以外のメッセージ（'みせいねん'）"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "score", "{", "echo", "}", "?>", "// scoreに85を入れる", "/", "以上 かつ 100以下 ならメッセージを出す", "ごうかくと出力"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "nums", "1, 2, 3", "n", "{", "echo", "}", "?>", "$nums = [1, 2, 3];", "oreach", "ums as $n) {", "// 数値配列（1、2、3）を$numsに代入", "/", "各要素を取り出す"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["<?php", "user", "'名前' => 'アリス'", "echo", "?>", "$user = ['名前' => 'アリス'];", "cho", "er['名前'", "// ユーザー情報の連想配列を作成", "/", "」キーで値を取得"]
        },
        "testCases": [
          {
            "input": "",
