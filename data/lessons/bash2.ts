export const bash2Data = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "holeyCode": "# ここに $ と入力して、ls コマンドの結果を受け取ってね\nfiles=___(ls)\necho \"Files: $files\"",
      "correctLines": [
        "files=$(ls)",
        "echo \"Files: $files\""
      ],
    ...
    },
    {
      ...
      "holeyCode": "# ここに << と入力して、文章をまとめて送ってね\ncat ___END\nHello\nWorld\nEND",
      "correctLines": [
        "cat <<END",
        "Hello",
        "World",
