  ...
  "exercises": [
    {
      ...
      "lineHints": [null, null, null, null, null, "-> でラムダ式を定義します。", null, "`apply` でラムダ式を実行します。", null, null],
      "candidates": {
        "operators": ["->", "=>", "::", "apply"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, "`asList` でリストを作成します。", null, "`stream` でStreamを作成します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`asList` でリストを作成します。", null, null, "`map` で各要素を変換します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`asList` でリストを作成します。", null, null, "`filter` で条件に合う要素を絞り込みます。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, "`asList` でリストを作成します。", null, null, null, "`collect` と `Collectors` でリストに変換します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`asList` でリストを作成します。", null, null, "`reduce` で要素を1つに集約します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`of` で値を持つOptionalを作成します。", null, "`orElse` でデフォルト値を指定して取得します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`asList` でリストを作成します。", null, ":: でメソッド参照を使います。", null, null],
      "candidates": {
        "operators": ["::", "->", ".", "asList"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`asList` でリストを作成します。", null, null, "`sorted` でソートします。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`asList` でリストを作成します。", null, null, "`distinct` で重複を除去します。", null, null, null],
      "candidates": {
