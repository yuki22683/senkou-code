      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["Main", "main", "String", "args", "System", "out", "println", "\"Try\"", ";", "Exception", "e", "\"Catch\"", "\"Finally\"", "}", "}", "atic", "で出力する", "inally で必ず実行する", "//", "println で出力する"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["java", "io", "*;", "", "Main", "riskyMethod", "Exception", "\"エラー！\"", "}", "main", "String", "args", ";", "e", "System", "out", "println", "\"Caught\"", "public class Main {", "atic", "tion", "void main", "String[] args", "// riskyMethod を呼び出す", "ion e) {"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["InvalidAgeException", "Exception", "String", "msg", "super", "}", "", "Main", "main", "args", "\"Invalid\"", "e", "System", "out", "println", "getMessage", "sg", "super で親クラスのコンストラクタを呼び出す", "public static void main(String[] args) {", "try {", "hrow", "ge でメッセージを取得する"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["java", "io", "*;", "", "Main", "main", "String", "args", "StringReader", "reader", "\"こんにちは\"", "System", "out", "println", "char", "read", "IOException", "e", "printStackTrace", "}", "eader", "public class Main {", "でリソースを宣言する", "字読み込む", "atch", "(IOException", "printStackTrace();"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["java", "io", "*;", "", "Main", "main", "String", "args", "IOException", "content", "\"Line1", "Line2\"", "BufferedReader", "br", "StringReader", "line", "readLine", "System", "out", "println", ";", "close", "}", "public class Main {", "g", "br = new BufferedReader", "new StringReader(content));", "br.readLine();", "System.out.println(line)", "br.close();"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["java", "nio", "file", "*;", "util", "", "Main", "main", "String", "args", "Exception", "Path", "path", "Paths", "get", "\".\"", ";", "boolean", "exists", "Files", "System", "out", "println", "}", "class Main {", "public static void main(String[] args) throws Exception {", "= Files.exists", "path);", "System.out.println(exists);"]
        },
        "testCases": [
          {
            "input": "",
