  ...
  "exercises": [
    {
      ...
      "lineHints": [null, null, null, "エラーが発生する可能性のある処理をここから記述します。", null, "整数型の変数を宣言し、初期値を代入します。", null, null, "文字列をコンソールに出力し、改行します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, "文字列をコンソールに出力し、改行します。", null, null, null, "エラーの有無に関わらず、最後に必ず実行する処理を記述します。", null, "文字列をコンソールに出力し、改行します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, "`throws` で例外をスローすることを宣言します。", null, "`throw` で例外をスローします。", null, null, null, null, "関数（riskyMethod）を呼び出して実行します。", null, null, "文字列をコンソールに出力し、改行します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "新しいクラス（InvalidAgeException）を定義します。", null, null, "`super` で親クラスのコンストラクタを呼び出します。", null, null, null, null, null, null, null, "`throw` で例外をスローします。", null, null, "`getMessage` でメッセージを取得します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`(` でリソースを宣言します。", null, "`read` で1文字読み込みます。", null, null, "`printStackTrace` でスタックトレースを出力します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, "`new` で BufferedReader を作成します。", null, "`readLine` で1行ずつ読み込みます。", null, "変数の値をコンソールに出力し、改行します。", null, "`close` でリソースを閉じます。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` で StringWriter を作成します。", null, "`new` で BufferedWriter を作成します。", null, "`write` で文字列を書き込みます。", null, "`flush` でバッファをフラッシュします。", null, "`toString` で文字列に変換します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "tutorialSlides": [
        ...
        {
          "title": "様々な読み込み方法",
          "image": "/illustrations/common/package_delivery.png",
      ...
      "lineHints": [null, null, null, null, null, "`new` で Scanner を作成します。", null, "`nextInt` で整数を読み込みます。", null, "`next` で文字列を読み込みます。", null, "`println` で出力します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, "`get` でパスを作成します。", null, "`exists` でファイルの存在を確認します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, "`null` を代入します。", null, "`length` メソッドを呼び出します。", null, "エラー（例外）が発生した場合の処理を記述します。", null, "文字列をコンソールに出力し、改行します。", null, null, null],
      "candidates": {
