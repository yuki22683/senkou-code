export const lua3Data = {
  ...
  "exercises": [
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["ok", "msg", "end", "print", "テスト エラー", "pcall", "match", "caught", "not caught", "and", "or", "errorでエラーを発生", "print(msg:match(\"テスト エラー\""]
        },
        "testCases": [
          {
            "input": "",
    ...
    {
      "title": "文字列を連結",
      "description": "複数の文字列をつなげて1つにする方法を学びます",
      "tutorialSlides": [
        {
          "title": "文字列の連結",
          "content": "# .. で連結\\n\\nLuaでは **..** 演算子で文字列を連結します。"
    ...
    {
      "title": "条件演算子のパターン",
      "description": "条件演算子のパターンの仕組みと使い方を学びます",
      "tutorialSlides": [
        {
          "title": "条件式パターン",
