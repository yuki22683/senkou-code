  ...
  "exercises": [
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, null, null, null, "Lock でロックを取得します。", null, null, "Unlock でロックを解放します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, null, "Add でカウンタを増やします。", null, null, null, "Done でカウンタを減らします。", null, null, null, null, "Wait でカウンタが0になるまで待ちます。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, "Background でルートコンテキストを作成します。", null, "Err でエラーを取得します。", null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, "WithCancel でキャンセル可能にします。", null, "関数（cancel）を呼び出して実行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, "変数を宣言し、同時に数値を代入します（型推論を使用）。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, null, null, null, null, "\"Apple\" を入力して構造体を初期化します。", null, "Marshal で JSON に変換します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, null, null, null, null, "\"Banana\" を入力してJSONを完成させます。", null, null, "Unmarshal で JSON をパースします。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, "\"hello,world\" を入力して文字列を設定します。", null, "Split で文字列を分割します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, "Atoi で文字列を整数に変換します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, null, null, "Args でコマンドライン引数を取得します。", null],
      "candidates": {
