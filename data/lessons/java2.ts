      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["Shape", "draw", "System", "out", "println", "\"Shape\"", ";", "}", "Circle", "Override", "\"Circle\"", "Main", "main", "String", "args", "c", "()", "id", "// @Override でメソッドを上書き宣言する", "void draw() {", "System.out.println(\"Circle\");", "Main {", "/ cにnew Circle", "// cでdrawメソッドを実行して描画"]
        },
        "testCases": [
          {
            "input": "",
