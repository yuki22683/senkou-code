  ...
  "exercises": [
    {
      ...
      "lineHints": [null, null, null, null, null, null, null, "新しいクラス（Car）を定義します。", null, null, null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`move` メソッドを呼び出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "tutorialSlides": [
        ...
        },
        {
          ...
          "image": "/illustrations/common/bridge_connection.png",
      ...
      "lineHints": [null, null, null, null, null, null, null, null, "`@Override` アノテーションを使います。", null, null, null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`draw` メソッドを呼び出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "新しいクラス（Person）を定義します。", null, null, null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`sayHello` メソッドを呼び出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, "`abstract` キーワードを使います。", null, null, null, null, null, null, null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`speak` メソッドを呼び出します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "エラーが発生する可能性のある処理をここから記述します。", null, "`parseInt` メソッドを使います。", null, null, null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, "文字列をコンソールに出力し、改行します。", null, null, null, "エラーの有無に関わらず、最後に必ず実行する処理を記述します。", null, null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`add` メソッドで要素を追加します。", null, "`add` メソッドで要素を追加します。", null, "`get` メソッドで要素を取得します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "配列の最初の要素を入力します。", null, "指定された回数や範囲で、繰り返し処理（ループ）を行います。", null, "変数の値をコンソールに出力し、改行します。", null, null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, "`static` キーワードを使います。", null, "`return` で値を返します。", null, null, null, null, null, null, "`multiply` メソッドを呼び出します。", null, "変数の値をコンソールに出力し、改行します。", null, null],
      "candidates": {
    ...
    },
    {
      ...
      "lineHints": [null, null, "`private` で外部からのアクセスを禁止します。", null, null, null, "`price` に値を代入します。", null, null, null, null, "変数の値を呼び出し元に返します（戻り値）。", null, null, null, null, null, null, "`new` でインスタンスを作成します。", null, "`getPrice` メソッドを呼び出します。", null, null],
      "candidates": {
