export const javaData2 = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "holeyCode": "// ここに abstract と入力して抽象クラスを作ってね\n___ class Animal {\n    abstract void speak();\n}\n\nclass Dog extends Animal {\n    void speak() {\n        System.out.println(\"Woof!\");\n    }\n}\n\nclass Main {\n    public static void main(String[] args) {\n        Dog d = new Dog();\n        d.speak();\n    }\n}",
      "correctLines": [
        "// ここに abstract と入力して抽象クラスを作ってね",
        "abstract class Animal {",
        "    abstract void speak();",
        "}",
        "",
    ...
    },
    {
      ...
      "holeyCode": "class Item {\n    // ここに private と入力して、外から見えないようにしてね\n    ___ int price;\n    \n    public Item(int p) {\n        price = p;\n    }\n    \n    public int getPrice() {\n        return price;\n    }\n}\n\nclass Main {\n    public static void main(String[] args) {\n        Item item = new Item(100);\n        System.out.println(item.getPrice());\n    }\n}",
      "correctLines": [
        "class Item {",
        "    private int price;",
        "    ",
