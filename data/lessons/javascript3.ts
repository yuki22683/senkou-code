export const javascriptData3 = {
  ...
  "exercises": [
      ...
      },
    {
        ...
        "holeyCode": "// awaitでPromiseを待つ\n// async で非同期関数を宣言\nasync function ___() {\n  // await でPromiseの結果を待つ\n  const ___ = await Promise.resolve(100);\n  // console.log で出力\n  console.log(___);\n___\n\n// main() で関数を呼び出す\n___();",
        "correctLines": [
          "// awaitでPromiseを待つ",
          "// async で非同期関数を宣言",
          "async function main() {",
      ...
      },
    {
        ...
        "holeyCode": "// p1 = 10 で解決するPromiseを作成\nconst ___ = Promise.resolve(10);\n// p2 = 20 で解決するPromiseを作成\nconst ___ = Promise.resolve(20);\n// all で全てのPromiseを待つ\nPromise.all([p___, p2]).then(nums => {\n  // nums[0] + nums[1] で合計を計算\n  console.___(nums[0] + nums[1]);\n___);",
        "correctLines": [
      ...
      },
    {
        ...
        "holeyCode": "// class キーワードでクラスを定義\nclass ___ {\n  // constructor でインスタンスを初期化\n  constructor(___) {\n    // this.name にnameを代入\n    this.___ = name;\n  ___\n  ___() {\n    // テンプレートリテラルで出力\n    console.___(`${this.name}: Woof!`);\n  ___\n___\n\n// new でインスタンスを作成\nconst ___ = new Dog('Pochi');\n// bark() メソッドを呼び出し\ndog.___();",
        "correctLines": [
          "// class キーワードでクラスを定義",
          "class Dog {",
          "  // constructor でインスタンスを初期化",
      ...
      },
    {
        ...
        "holeyCode": "// 静的メソッドを持つクラス\n// class でクラスを定義\nclass ___ {\n  // static でクラスメソッドを定義\n  static multiply(a, ___) {\n    // return で戻り値\n    return a * ___;\n  ___\n___\n\n// クラス名.メソッド名() で静的メソッドを呼び出し\nconsole.___(Calculator.multiply(3, 4));",
        "correctLines": [
          "// 静的メソッドを持つクラス",
          "// class でクラスを定義",
          "class Calculator {",
      ...
      },
    {
        ...
        "holeyCode": "// user: { name: 'Bob' } を持つオブジェクトを定義し、Optional Chainingで安全にアクセス\nconst ___ = { user: { name: 'Bob' } };\n// ?. で安全にプロパティにアクセス\nconsole.___(data?.user?.name);\n// 存在しないプロパティにアクセス\nconsole.___(data?.profile?.age);",
        "correctLines": [
