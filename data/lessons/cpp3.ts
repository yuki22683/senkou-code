export const cpp3Data = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\nusing namespace std;\n\n// ここに constexpr と入力して、計算を先にしておいてね\n___ int cube(int x) {\n    return x * x * x;\n}\n\nint main() {\n    constexpr int val = cube(3);\n    cout << val << endl;\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "using namespace std;",
        "",
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\n#include <memory>\nusing namespace std;\n\nint main() {\n    // ここに make_shared と入力して、みんなで使えるポインタを作ってね\n    auto p = ___<int>(100);\n    cout << *p << endl;\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "#include <memory>",
        "using namespace std;",
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "#include <iostream>\n#include <optional>\nusing namespace std;\n\nint main() {\n    optional<int> opt = 42;\n    if (opt.has_value()) {\n        cout << opt.value() << endl;\n    }\n    return 0;\n}",
      "holeyCode": "#include <iostream>\n#include <optional>\nusing namespace std;\n\nint main() {\n    optional<int> opt = 42;\n    // ここに has_value と入力して、中身があるか調べてね\n    if (opt.___()) {\n        cout << opt.value() << endl;\n    }\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "#include <optional>",
        "using namespace std;",
    ...
    },
    {
      ...
      "holeyCode": "#include <iostream>\n#include <array>\nusing namespace std;\n\nint main() {\n    // ここに array と入力して、決まった長さの配列を作ってね\n    ___<int, 3> arr = {10, 20, 30};\n    for (int n : arr) cout << n << \" \";\n    cout << endl;\n    return 0;\n}",
      "correctLines": [
        "#include <iostream>",
        "#include <array>",
        "using namespace std;",
