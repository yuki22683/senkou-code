  ...
  "exercises": [
    {
      ...
      "holeyCode": "___"Hello, Java!\" と入力してね\n        System.out.println(\"___\");\n    }\n}",
      "correctLines": [
        ""public class Main {",\n        "    public static void main(String["
      ] args) {",
        "        // ここに \"Hello, Java!\" と入力してね",
        "        System.out.println(\"Hello, Java!\");",
        "    }",
        "}"
      ],
