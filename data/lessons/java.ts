  ...
  "exercises": [
    {
      ...
      "lineHints": [null, null, null, "System.out.println を使用します。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "String name = \"Java\"; とします。", "変数名 name を出力します。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, "10を代入します。", "5を代入します。", "足し算には + を使います。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "+ age + のように変数を挟みます。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, "{\"red\", \"blue\"} と記述します。", "インデックス1を指定します。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "score > 80 と記述します。", "満点です！ を出力します。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, null, null, null, "else を記述します。", "未成年 を出力します。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "for (String name : names) と記述します。"],
    ...
    },
    {
      ...
      "lineHints": [null, null, null, "new HashMap<>(); とします。", "put メソッドで追加します。", "get メソッドで取得します。"],
    ...
    },
    {
      ...
      "lineHints": [null, "greet() という名前で定義します。", null, null, null, "greet(); で呼び出します。"],
