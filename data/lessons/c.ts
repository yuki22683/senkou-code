  ...
  "exercises": [
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "変数の値を指定された形式で画面に表示します。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "functions": [
          "printf"
        ],
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "整数型の変数を宣言し、初期値を代入します。", null, "変数の値を指定された形式で画面に表示します。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {},
      "testCases": [
        {
          "input": "",
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "整数型の変数を宣言し、初期値を代入します。", null, "整数型の変数を宣言し、初期値を代入します。", null, "変数の値を指定された形式で画面に表示します。", null, "return 0; で正常終了を返します。", null, "} で関数を閉じます。", null],
      "candidates": {
        "operators": [
          "+"
        ]
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "整数型の変数を宣言し、初期値を代入します。", null, "変数の値を計算して、その結果を同じ変数に再代入します。", null, "変数の値を指定された形式で画面に表示します。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "operators": ["+=", "-=", "*=", "/="],
        "numbers": ["50", "10"]
      },
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "複数の値をまとめて格納する配列（またはリスト）を作成します。", null, "変数の値を指定された形式で画面に表示します。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "numbers": [
          "1"
        ]
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "整数型の変数を宣言し、初期値を代入します。", null, "条件式（変数と数値の比較など）を評価し、真の場合にブロックを実行します。", null, "指定された文字列を画面に表示する関数を使用します。", null, "} でif文を閉じます。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "operators": [
          ">"]
      },
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "整数型の変数を宣言し、初期値を代入します。", null, "条件式（変数と数値の比較など）を評価し、真の場合にブロックを実行します。", null, "指定された文字列を画面に表示する関数を使用します。", null, "もし条件が満たされなかった場合に実行する処理を記述します。", null, "指定された文字列を画面に表示する関数を使用します。", null, "} でif-else文を閉じます。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "keywords": ["else"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "指定された回数や範囲で、繰り返し処理（ループ）を行います。", null, "変数の値を指定された形式で画面に表示します。", null, "} でfor文を閉じます。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "operators": ["i++"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "tutorialSlides": [
        ...
        {
          "title": "struct（ストラクト）",
          "image": "/illustrations/3d/monitor.png",
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "構造体（Point）を定義します。", null, "int x; でメンバ変数を宣言します。", null, "int y; でメンバ変数を宣言します。", null, "}; で構造体定義を終了します（セミコロン必須）。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "構造体（Point）を定義します。", null, "変数の値を指定された形式で画面に表示します。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "strings": ["x"]
      },
      "testCases": [
    ...
    },
    {
      ...
      "lineHints": [null, "標準入出力ライブラリを読み込み、使用可能にします。", null, "void型の値を返す関数（greet）を定義します。", null, "指定された文字列を画面に表示する関数を使用します。", null, "} でgreet関数を閉じます。", null, "プログラムの実行開始地点（エントリーポイント）となる関数を定義します。", null, "関数（greet）を呼び出して実行します。", null, "プログラムが正常に終了したことを示す値（通常は0）を返します。", null, "} で関数を閉じます。"],
      "candidates": {
        "functions": ["greet"]
      },
      "testCases": [
