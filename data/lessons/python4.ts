      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["Person", "__init__", "name", "Student", "grade", "3", "print", "", "たろう", "s"]
        },
        "testCases": [
          {
            "input": "",
            "expected_output": "たろう is in grade 3\\n"
          }
        ]
      },
    {
      ...
      "holeyCode": "# classでRectangleクラスを定義\\nclass ___:\\n    # defで__init__メソッドを定義（引数: self, width, height）\\n    def ___(self, ___, ___):\\n        # self.widthにwidthを代入\\n        self.___ = ___\\n        # self.heightにheightを代入\\n        self.___ = ___\\n    \\n    # @propertyデコレータ\\n    @___\\n    # defでareaメソッドを定義（引数: selfのみ）\\n    def ___(self):\\n        # returnでself.widthとself.heightの積を返す\\n        return self.___ * self.___\\n\\n# Rectangleを作成（幅に4, 高さに5）しrに代入\\n___ = ___(___, ___)\\n# print関数でr.areaを表示\\n___(___.___)",
      "correctLines": [
          "# classでRectangleクラスを定義",
          "class Rectangle:",
          "    # defで__init__メソッドを定義（引数: self, width, height）",
          "    def __init__(self, width, height):",
          "        # self.widthにwidthを代入",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["Book", "__init__", "title", "author", "Pythonガイド", "たろう", "book", "print", ""]
        },
        "testCases": [
          {
            "input": "",
            "expected_output": "Pythonガイド by たろう\\n"
          }
        ]
      },
    {
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["dataclasses", "dataclass", "Person", "name", "str", "age", "int", "p", "たろう", "25", "print", ""]
        },
        "testCases": [
          {
            "input": "",
            "expected_output": "Person(name='たろう', age=25)\\n"
          }
        ]
      }
  ]
