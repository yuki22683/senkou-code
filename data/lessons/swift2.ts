export const swift2Data = {
  ...
  "exercises": [
    ...
    {
      "title": "オプショナルバインディング",
      "description": "if let（イフ・レット）について学びます",
      "tutorialSlides": [
        {
          "title": "if let とは？",
    ...
    {
      "title": "クロージャを使おう",
      "description": "クロージャ（closure）について学びます",
      "tutorialSlides": [
        {
          "title": "クロージャとは？",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["check", "\"nil\"", "n", "_", "val", "Int", "print", "}", "10", "{", "// printでnを出力", "check(10)"]
        },
        "testCases": [
          {
            "input": "",
      ...
      },
    {
      ...
      "lineHints": [
        ...
        "candidates": {
          ...
          "others": ["red", "c", "green", "blue", "Color", "}", "print", "{", "\"あか\"", "\"みどり\"", "\"あお\"", "// 赤色をcに代入", "witchでパターンマッチ", "ed:", "int(\"あか\")", "// 緑色を出力"]
        },
        "testCases": [
          {
            "input": "",
