      ...
      "tutorialSlides": [
        {
          ...
          "content": "# Webサイトを動かす魔法の言葉\\n\\nJavaScript（ジャバスクリプト）は、Webサイトに「動き」をつけるためのプログラミング言語です。\\n\\n**たとえば、こんなことができます：**\\n- ボタンをクリックしたら何かが起きる\\n- 画面がキラキラ動くアニメーション\\n- ゲームのキャラクターを動かす\\n\\n世界中でとても人気があり、ゲームやスマホアプリ作りにも使われています。"
        },
        {
          "title": "メッセージを出す「出力」",
