...
export const javascriptData = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "correctCode": "// xに10を代入\nconst x = 10;\n// yに5を代入\nconst y = 5;\n// x + y を出力\nconsole.log(x + y);",
      "holeyCode": "// xに10を代入\nconst x = ___ ;\n// yに5を代入\nconst y = ___ ;\n// x + y を出力\nconsole.log(x ___ y);",
      "correctLines": ["// xに10を代入", "const x = 10;", "// yに5を代入", "const y = 5;", "// x + y を出力", "console.log(x + y);"],
      "lineHints": [null, "const x = 10; とします。", null, "const y = 5; とします。", null, "x + y を console.log に渡します。"],
      "candidates": { "variables": ["x", "y"], "functions": ["console.log"], "operators": ["+"], "numbers": ["10", "5"] },
    ...
    },
    {
      ...
      "correctLines": ["// 配列colorsを作成", "const colors = ['red', 'blue'];", "// 2番目の要素を出力", "console.log(colors[1]);"],
      "lineHints": [
        null,
        "['red', 'blue'] と記述します。",
        null,
    ...
    },
    {
      ...
      "holeyCode": "// オブジェクトを作成\nconst user = { ___: '___' };\n// 値を表示\nconsole.log(user.name);",
      "correctLines": ["// オブジェクトを作成", "const user = { name: 'Alice' };", "// 値を表示", "console.log(user.name);"],
      "lineHints": [
        null,
        "{ name: 'Alice' } と記述します。",
        null,
