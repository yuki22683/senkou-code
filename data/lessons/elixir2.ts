  ...
  "exercises": [
    {
      ...
      "correctCode": "{x, y} = {10, 20}\nIO.puts x",
      "holeyCode": "{x, ___} = {10, 20}\nIO.puts x",
      "correctLines": [
        "{x, y} = {10, 20}",
        "IO.puts x"
      ],
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "[head | tail] = [1, 2, 3]\nIO.puts head",
      "holeyCode": "[head ___ tail] = [1, 2, 3]\nIO.puts head",
      "correctLines": [
        "[head | tail] = [1, 2, 3]",
        "IO.puts head"
      ],
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "result = Enum.map([1, 2, 3], fn x -> x * x end)\nIO.inspect result",
      "holeyCode": "result = Enum.___ ([1, 2, 3], fn x -> x * x end)\nIO.inspect result",
      "correctLines": [
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "result = Enum.filter([1, 2, 3, 4, 5], fn x -> x >= 3 end)\nIO.inspect result",
      "holeyCode": "result = Enum.___ ([1, 2, 3, 4, 5], fn x -> x >= 3 end)\nIO.inspect result",
      "correctLines": [
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "spawn(fn -> IO.puts \"hello\" end)\nProcess.sleep(100)",
      "holeyCode": "___(fn -> IO.puts \"hello\" end)\nProcess.sleep(100)",
      "correctLines": [
        "spawn(fn -> IO.puts \"hello\" end)",
        "Process.sleep(100)"
      ],
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "send(self(), {:msg, 42})\nreceive do\n  {:msg, n} -> IO.puts n\nend",
      "holeyCode": "___(self(), {:msg, 42})\nreceive do\n  {:msg, n} -> IO.puts n\nend",
      "correctLines": [
        "send(self(), {:msg, 42})",
        "receive do",
        "  {:msg, n} -> IO.puts n",
