export const typescriptData2 = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "// Personインターフェースを定義\ninterface Person {\n    name: string;\n    age: number;\n}\n\nconst p: Person = { name: 'Alice', age: 25 };\nconsole.log(p.name);",
      "holeyCode": "// Personインターフェースを定義\n___ Person {\n    name: string;\n    age: number;\n}\n\nconst p: Person = { name: 'Alice', age: 25 };\nconsole.log(p.name);",
      "correctLines": [
        "// Personインターフェースを定義",
        "interface Person {",
        "    name: string;",
