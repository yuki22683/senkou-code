  ...
  "exercises": [
    {
        ...
        "lineHints": [
          ...
          null,
          "voidは戻り値がないメソッドを表します。",
          null,
          "文字列をコンソールに出力し、改行します。",
          "新しいクラス（Car）を定義します。",
          "newキーワードでインスタンスを作成します。",
          null,
          "継承したMoveメソッドを呼び出します。",
          null,
          null,
      ...
      },
    {
        ...
        "lineHints": [
          ...
          "新しいクラス（Shape）を定義します。",
          null,
          "virtualで子クラスでの上書きを許可します。",
          null,
          "文字列をコンソールに出力し、改行します。",
          "新しいクラス（Circle）を定義します。",
          "overrideで親クラスのメソッドを上書きします。",
          null,
          "文字列をコンソールに出力し、改行します。",
          null,
          "newキーワードでインスタンスを作成します。",
          null,
          "上書きされたDrawメソッドが呼ばれます。",
          null,
          null,
          null,
          null,
      ...
      },
    {
        ...
        "lineHints": [
          null,
          "interfaceでインターフェースを定義します。",
          null,
          "void型の値を返す関数（Run）を定義します。",
          "新しいクラス（Robot）を定義します。",
          null,
          "voidは戻り値がないメソッドを表します。",
          null,
