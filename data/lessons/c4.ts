export const c4Data = {
  ...
  "exercises": [
      ...
      },
    {
      ...
      "correctCode": "// #includeでstdio.hを読み込む\\n#include <stdio.h>\\n\\n// int mainでmain関数を定義\\nint main() {\\n    // FILE *fpでfopen(「データ.txt」を書き込みモード)の結果を代入\\n    FILE *fp = fopen(\"データ.txt\", \"w\");\\n    // ifでfpがNULLでないか判定\\n    if (fp != NULL) {\\n        // fputsでfpに「Data」を書き込む\\n        fputs(\"Data\\n\", fp);\\n        // fcloseでfpを閉じる\\n        fclose(fp);\\n        // printfで「Closed」を出力\\n        printf(\"Closed\\n\");\\n    // ifブロックを閉じる\\n    }\\n    // return 0で正常終了を返す\\n    return 0;\\n// ブロックを閉じる\\n}", "holeyCode": "// #includeでstdio.hを読み込む\\n#___ <___>\\n\\n// int mainでmain関数を定義\\n___ ___() {\\n    // FILE *fpでfopen(「データ.txt」を書き込みモード)の結果を代入\\n    ___ *___ = ___(\\\"___\\\", \\\"___\\\");\\n    // ifでfpがNULLでないか判定\\n    ___ (___ != ___) {\\n        // fputsでfpに「Data」を書き込む\\n        ___(\\\"___\\\", ___);\\n        // fcloseでfpを閉じる\\n        ___(___);\\n        // printfで「Closed」を出力\\n        ___(\\\"___\\\");\\n    // ifブロックを閉じる\\n    ___\\n    // return 0で正常終了を返す\\n    ___ ___;\\n// ブロックを閉じる\\n___",
      "correctLines": [
          "// #includeでstdio.hを読み込む",
          "#include <stdio.h>",
          "",
      ...
      },
    {
      ...
      "correctCode": "// #includeでstdio.hを読み込む\\n#include <stdio.h>\\n\\n// int mainでmain関数を定義\\nint main() {\\n    // FILE *fpでfopen(「log.txt」を書き込みモード)の結果を代入\\n    FILE *fp = fopen(\"log.txt\", \"w\");\\n    // ifでfpがNULLでないか判定\\n    if (fp != NULL) {\\n        // fprintfでfpに「Score: 100」を書き込む\\n        fprintf(fp, \"Score: %d\\n\", 100);\\n        // fcloseでfpを閉じる\\n        fclose(fp);\\n        // printfで「Written」を出力\\n        printf(\"Written\\n\");\\n    // ifブロックを閉じる\\n    }\\n    // return 0で正常終了を返す\\n    return 0;\\n// ブロックを閉じる\\n}", "holeyCode": "// #includeでstdio.hを読み込む\\n#___ <___>\\n\\n// int mainでmain関数を定義\\n___ ___() {\\n    // FILE *fpでfopen(「log.txt」を書き込みモード)の結果を代入\\n    ___ *___ = ___(\\\"___\\\", \\\"___\\\");\\n    // ifでfpがNULLでないか判定\\n    ___ (___ != ___) {\\n        // fprintfでfpに「Score: 100」を書き込む\\n        ___(___,  \\\"___\\\", ___);\\n        // fcloseでfpを閉じる\\n        ___(___);\\n        // printfで「Written」を出力\\n        ___(\\\"___\\\");\\n    // ifブロックを閉じる\\n    ___\\n    // return 0で正常終了を返す\\n    ___ ___;\\n// ブロックを閉じる\\n___",
      "correctLines": [
          "// #includeでstdio.hを読み込む",
          "#include <stdio.h>",
          "",
      ...
      },
    {
      ...
      "correctCode": "// #includeでstdio.hを読み込む\\n#include <stdio.h>\\n// #includeでstring.hを読み込む\\n#include <string.h>\\n\\n// int mainでmain関数を定義\\nint main() {\\n    // char line[100]で100文字のバッファlineを宣言\\n    char line[100];\\n    // FILE *fpでfopen(「テスト.txt」を書き込みモード)の結果を代入\\n    FILE *fp = fopen(\"テスト.txt\", \"w\");\\n    // fprintfでfpに「Hello World」を書き込む\\n    fprintf(fp, \"Hello World\\n\");\\n    // fcloseでfpを閉じる\\n    fclose(fp);\\n    // fpにfopen(「テスト.txt」を読み込みモード)を再代入\\n    fp = fopen(\"テスト.txt\", \"r\");\\n    // fgetsでfpから1行をlineに読み込む\\n    fgets(line, sizeof(line), fp);\\n    // strcspnで改行位置を探し0を代入して除去\\n    line[strcspn(line, \"\\n\")] = 0;\\n    // printfでlineを出力\\n    printf(\"%s\\n\", line);\\n    // fcloseでfpを閉じる\\n    fclose(fp);\\n    // return 0で正常終了を返す\\n    return 0;\\n// ブロックを閉じる\\n}", "holeyCode": "// #includeでstdio.hを読み込む\\n#___ <___>\\n// #includeでstring.hを読み込む\\n#___ <___>\\n\\n// int mainでmain関数を定義\\n___ ___() {\\n    // char line[100]で100文字のバッファlineを宣言\\n    ___ ___[___];\\n    // FILE *fpでfopen(「テスト.txt」を書き込みモード)の結果を代入\\n    ___ *___ = ___(\\\"___\\\", \\\"___\\\");\\n    // fprintfでfpに「Hello World」を書き込む\\n    ___(___,  \\\"___\\\");\\n    // fcloseでfpを閉じる\\n    ___(___);\\n    // fpにfopen(「テスト.txt」を読み込みモード)を再代入\\n    ___ = ___(\\\"___\\\", \\\"___\\\");\\n    // fgetsでfpから1行をlineに読み込む\\n    ___(___,  ___(___), ___);\\n    // strcspnで改行位置を探し0を代入して除去\\n    ___[___(___,  \\\"___\\\")] = ___;\\n    // printfでlineを出力\\n    ___(\\\"___\\\", ___);\\n    // fcloseでfpを閉じる\\n    ___(___);\\n    // return 0で正常終了を返す\\n    ___ ___;\\n// ブロックを閉じる\\n___",
      "correctLines": [
          "// #includeでstdio.hを読み込む",
          "#include <stdio.h>",
          "// #includeでstring.hを読み込む",
      ...
      },
    {
      ...
      "correctCode": "// #includeでstdio.hを読み込む\\n#include <stdio.h>\\n\\n// union ValueでValue共用体を定義\\nunion Value {\\n    // int iでintメンバiを宣言\\n    int i;\\n    // double dでdoubleメンバdを宣言\\n    double d;\\n// 共用体定義を閉じる\\n};\\n\\n// int mainでmain関数を定義\\nint main() {\\n    // union Value vで共用体変数vを宣言\\n    union Value v;\\n    // v.iに42を代入\\n    v.i = 42;\\n    // printfでv.iを出力\\n    printf(\"%d\\n\", v.i);\\n    // return 0で正常終了を返す\\n    return 0;\\n// ブロックを閉じる\\n}", "holeyCode": "// #includeでstdio.hを読み込む\\n#___ <___>\\n\\n// union ValueでValue共用体を定義\\n___ ___ {\\n    // int iでintメンバiを宣言\\n    ___ ___;\\n    // double dでdoubleメンバdを宣言\\n    ___ ___;\\n// 共用体定義を閉じる\\n___\\n\\n// int mainでmain関数を定義\\n___ ___() {\\n    // union Value vで共用体変数vを宣言\\n    ___ ___ ___;\\n    // v.iに42を代入\\n    ___.___  = ___;\\n    // printfでv.iを出力\\n    ___(\\\"___\\\", ___.___);\\n    // return 0で正常終了を返す\\n    ___ ___;\\n// ブロックを閉じる\\n___",
      "correctLines": [
          "// #includeでstdio.hを読み込む",
          "#include <stdio.h>",
          "",
