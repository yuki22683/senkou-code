  ...
  "exercises": [
    {
      ...
      "holeyCode": "# 名前を受け取るために name と入力してね\ndef hello(___):\n    # ここに name と入力してあいさつを表示してね\n    print(f'Hello, {___}!')\n\n# 関数を呼び出す\nhello('Python')",
      "correctLines": [
        "# 名前を受け取るために name と入力してね",
        "def hello(name):",
        "    # ここに name と入力してあいさつを表示してね",
        "    print(f'Hello, {name}!')",
        "",
    ...
    },
    {
      ...
      "holeyCode": "# ここに 'World' と入力してデフォルト値を決めてね\ndef say_hi(name=___):\n    print(f'Hi, {name}!')\n\n# 引数なしで呼び出す\nsay_hi()",
      "correctLines": [
        "# ここに 'World' と入力してデフォルト値を決めてね",
        "def say_hi(name='World'):",
        "    print(f'Hi, {name}!')",
        "",
        "# 引数なしで呼び出す",
    ...
    },
    {
      ...
      "initialDisplayMode": "holey",
      "correctCode": "# 文字列を用意\nword = 'Programming'\n# 最初の4文字を取り出す\nprint(word[0:4])",
      "holeyCode": "# 文字列を用意\nword = 'Programming'\n# 0番目から4番目の手前までを取り出すために 0 と 4 を入力してね\nprint(word[___:___])",
      "correctLines": [
        "# 文字列を用意",
        "word = 'Programming'",
        "# 0番目から4番目の手前までを取り出すために 0 と 4 を入力してね",
    ...
    },
    {
      ...
      "holeyCode": "# ここに for と入力して繰り返し処理を書いてね\ndoubled = [x * 2 ___ x in range(1, 6)]\nprint(doubled)",
      "correctLines": [
        "# ここに for と入力して繰り返し処理を書いてね",
        "doubled = [x * 2 for x in range(1, 6)]",
        "print(doubled)"
      ],
      "lineHints": [
    ...
    },
    {
      ...
      "holeyCode": "# ここに if と入力して条件を追加してね\nmultiples = [n for n in range(1, 11) ___ n % 3 == 0]\nprint(multiples)",
      "correctLines": [
        "# ここに if と入力して条件を追加してね",
        "multiples = [n for n in range(1, 11) if n % 3 == 0]",
        "print(multiples)"
      ],
      "lineHints": [
    ...
    },
    {
      ...
      "holeyCode": "# ここに try と入力してエラーを見張ってね\n___:\n    num = int('abc')\nexcept:\n    print('Error')",
      "correctLines": [
        "# ここに try と入力してエラーを見張ってね",
        "try:",
        "    num = int('abc')",
        "except:",
        "    print('Error')"
