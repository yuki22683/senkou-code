export const perlData = {
  ...
  "exercises": [
      ...
      },
    {
      ...
      "lineHints": [
          null,
          "my で変数$aを宣言し、7を代入します。",
          null,
          "my で変数$bを宣言し、3を代入します。",
          null,
          "$a + $b の結果を$sumに代入します。",
          null,
          "print で計算結果を出力します。"
      ...
      },
    {
      ...
      "lineHints": [
          null,
          "@で配列を定義し、複数の値をカッコ内に並べます。",
          null,
          "配列の要素は$配列名[インデックス]でアクセスします。"
        ],
        "candidates": {
          "variables": [
            "@fruits",
      ...
      },
    {
      ...
      "lineHints": [
          ...
          "スカラー変数$numに5を代入します。",
          null,
          "ifで条件式を評価し、ブロックを開きます。",
          null,
          "条件が真の場合に実行されます。",
          null,
          "elseで条件が偽の場合の処理を開始します。",
          null,
          "条件が偽の場合に実行されます。",
          "閉じ括弧でブロックを終了します。"
        ],
      ...
      },
    {
      ...
      "lineHints": [
          null,
          "@で配列を定義し、要素をカッコ内に並べます。",
          null,
          "foreachで配列の各要素をループします。",
          null,
          "ループ変数$animalを出力します。",
          "閉じ括弧でブロックを終了します。"
        ],
