export const rust2Data = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "holeyCode": "struct Square {\n    side: i32,\n}\n// ここに impl と入力して「この構造体で使う関数」を作ってね\n___ Square {\n    fn area(&self) -> i32 {\n        self.side * self.side\n    }\n}\nfn main() {\n    let s = Square { side: 5 };\n    println!(\"{}\", s.area());\n}",
      "correctLines": [
        "struct Square {",
        "    side: i32,",
        "}",
