...
export const LANGUAGE_COLORS: Record<string, string> = {
  python: 'bg-sky-50 hover:bg-sky-100 border-sky-200',
  ...
  c: 'bg-slate-50 hover:bg-slate-100 border-slate-200',
  cpp: 'bg-indigo-50 hover:bg-indigo-100 border-indigo-200',
  csharp: 'bg-violet-50 hover:bg-violet-100 border-violet-200',
  go: 'bg-cyan-50 hover:bg-cyan-100 border-cyan-200',
  rust: 'bg-orange-50 hover:bg-orange-100 border-orange-200',
  ruby: 'bg-rose-50 hover:bg-rose-100 border-rose-200',
  php: 'bg-indigo-50 hover:bg-indigo-100 border-indigo-200',
  bash: 'bg-neutral-100 hover:bg-neutral-200 border-neutral-300',
  haskell: 'bg-purple-50 hover:bg-purple-100 border-purple-200',
  elixir: 'bg-fuchsia-50 hover:bg-fuchsia-100 border-fuchsia-200',
  ...
  swift: 'bg-amber-50 hover:bg-amber-100 border-amber-200',
  perl: 'bg-teal-50 hover:bg-teal-100 border-teal-200',
};